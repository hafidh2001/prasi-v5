...
type PQuerySelectRel = { rel_name: REL_NAME, type: "relation", as?: string; } & Partial<Omit<PQuerySelect, 'table' | 'action'>>
type PQuerySelectWhere = { column: COL_NAME, operator: WHERE_OPERATOR; value?: any }
