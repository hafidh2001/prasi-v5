...
export const runTsWrapper = async (htmlElement: HTMLDivElement) => {
  ...
  try {
    ...
    document
      .querySelector("#button-swap-code")
      ?.addEventListener("click", () => {
        const codeResources = wrapper
          .getMonacoEditorApp()
          ?.getConfig().codeResources;
    ...
    document
      .querySelector("#button-diff")
      ?.addEventListener("click", async () => {
        // ensure it is boolean value and not undefined
        const useDiffEditor =
          userConfig.wrapperConfig.editorAppConfig.useDiffEditor ?? false;
