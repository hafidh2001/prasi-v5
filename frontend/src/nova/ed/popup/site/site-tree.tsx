      ...
      return (
        ...
        >
          <div className="flex flex-col p-1">
            <div className="text-[13px] flex items-end min-h-[28px] max-h-[34px] pb-[2px] leading-4 overflow-hidden">
              {node.text}
            </div>
            <div
              className={cx(
                "text-slate-500 flex items-center space-x-1 text-[12px] overflow-hidden",
            ...
            >
              ...
              ></div>
              <div className="overflow-hidden h-[20px]">{sitem.domain} &nbsp;</div>
            </div>
