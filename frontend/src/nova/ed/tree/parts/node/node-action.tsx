...
export const EdTreeAction = ({
  ...
  let mode = "";
  if (!mode && item.adv?.flow) mode = "flow";
  if (!mode && item.adv?.js) mode = "js";
        ...
        <Tooltip content={`Edit ${mode}`} asChild>
          <div
            className={cx(
              ...
              no_adv &&
                `bg-purple-100  border-purple-200 hover:border-purple-500 hover:text-purple-900 hover:bg-purple-300`,
              mode === "flow" &&
                `bg-purple-100 border-purple-200 hover:border-purple-500 hover:text-purple-900 hover:bg-purple-300`,
              mode === "js" &&
          ...
          >
            {mode !== "flow" && !no_adv ? (
              ...
              <Scroll size={10} strokeWidth={1.5} />
            )}
          </div>
        </Tooltip>
      )}
