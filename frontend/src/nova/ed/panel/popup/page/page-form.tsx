    ...
    <>
      <div
        className="absolute inset-0 flex items-center justify-center
           backdrop-blur cursor-pointer hover:backdrop-blur-sm transition-all text-xs"
        onPointerUp={() => {
          ...
          onSubmit={async (e) => {
            ...
            if (form.name) {
              ...
              if (!form.id) {
                ...
                if (p.page.cur.id === form.id && p.page.doc) {
                  p.page.doc.transact(() => {
                    if (p.page.doc) {
                      const page = p.page.doc.getMap("map");
                      if (page) {
